...
public class Nightdata implements Serializable {
	private static final long serialVersionUID = 1L;
	private Long nightData_Id;//夜晚数据表ID
	...
	/**
	* 获取 夜晚数据表ID
	* @return  nightData_Id 夜晚数据表ID
	* 由CSMMAACToolv4.0.5生成
	*/
	public Long getNightData_Id(){
		return nightData_Id;
	}
	/**
	* 设置 夜晚数据表ID
	* @param  nightData_Id 夜晚数据表ID
	* 由CSMMAACToolv4.0.5生成
	*/
	public void setNightData_Id(Long nightData_Id){
	this.nightData_Id=nightData_Id;
	}
	/**
	* 获取 设备ID
	...
	*/
	public String getAcquisitionTimeString(){
		return  StrUtil.Timesamp2String(acquisitionTime);
	}
	/**
	* 获取 导入时间
	* @return  genTime 导入时间
...
/**
	...
	public Map<String, Object> toMap() {
		...
		if (null != nightData_Id) {
			map.put("nightData_Id", nightData_Id);
		}
	...
	return "Nightdata [nightData_Id=" +nightData_Id+",equipment_Id=" +equipment_Id+",imageName=\"" +imageName+"\",indoorTemperature=" +indoorTemperature+",bodyTemperature=" +bodyTemperature+",acquisitionTime=\"" + StrUtil.Timesamp2String(acquisitionTime)+"\",genTime=\"" + StrUtil.Timesamp2String(genTime)+"\",Equipment="  +equipment+""+"]"; 
	} 
}
